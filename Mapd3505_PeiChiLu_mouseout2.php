...
<meta charset='utf-8'>
<title>Mapd3505_呂珮綺_作業二_Lottery:送樂透號碼回前端(mouseout觸發）</title>
...
// this output will pop up same random number in array
	   ...
	   btn.addEventListener("mouseout", processEvent); //觸發事件，addEventListenter：做事的傾聽器
...
<body style="background-color:#ffe24f;">
	...
	<a href="Mapd3505_PeiChiLu_mouseout2.php" style="margin-right:20px;font-family: 'Noto Sans TC', sans-serif;text-decoration: auto;color:#000000;background-color: white;">作業二 mouse out觸發</a>
	<a href="Mapd3505_PeiChiLu_mouseover3.php" style="margin-right:20px;font-family: 'Noto Sans TC', sans-serif;text-decoration: auto;color:#ffffff;">作業三 mouseover觸發</a>
	<br />
    </div>
	<div align="center" style="margin:100px;">
	    
		<h1>作業二&nbsp;<br>Mouse out觸發</h1>
        <h3>本作業是練習JavaScript事件處理，此系列共練習三種方式觸發事件處理：作業一Click觸發、作業二mouse out觸發、作業三mouseover觸發。<br>
        此程式是利用JavaScript送出隨機的樂透號碼，當滑鼠離開"mouse out from me"按鈕，將產生一組介於1~49之間的隨機二位整數六碼。再次把滑鼠移進按鈕範圍再移出會再產生新的一組號碼，但舊的隨機號碼將會消失，不會有歷史記錄。</h3>
		<button id='btn' style="font-family: 'Noto Sans TC', sans-serif;background-color:#ffffff;font-size: x-large;
    cursor: pointer;margin-top: 50px;margin-bottom:50px;"> mouse out from me </button>
